...
export const getRecipeHistoryData = (searchQuery,sort,status,categoryId) =>{
  return axios.get(API_BASE_URL + `/serve-histories?limit=10&q=${searchQuery}&sort=${sort}&status=${status}&categoryId=${categoryId}`,
